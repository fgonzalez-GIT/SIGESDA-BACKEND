...
exports.reorderCatalogoAulasSchema = exports.queryTiposAulasCatalogoSchema = exports.queryCatalogosAulasSchema = exports.updateEstadoAulaSchema = exports.createEstadoAulaSchema = exports.updateTipoAulaSchema = exports.createTipoAulaSchema = void 0;
...
exports.createEstadoAulaSchema = zod_1.z.object({
    codigo: zod_1.z.string()
        .min(1, 'El código es requerido')
        .max(50, 'El código no puede exceder 50 caracteres')
        .regex(/^[A-Z_]+$/, 'El código debe estar en mayúsculas y usar guiones bajos'),
...
exports.updateEstadoAulaSchema = exports.createEstadoAulaSchema.partial();
exports.queryCatalogosAulasSchema = zod_1.z.object({
...
exports.queryTiposAulasCatalogoSchema = zod_1.z.object({
...
exports.reorderCatalogoAulasSchema = zod_1.z.object({
    ids: zod_1.z.array(zod_1.z.number().int().positive()).min(1, 'Debe proporcionar al menos un ID')
});
//# sourceMappingURL=catalogos-aulas.dto.js.map