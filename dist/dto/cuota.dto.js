...
exports.createCuotaSchema = zod_1.z.object({
    ...
    categoriaId: zod_1.z.string().cuid('ID de categoría inválido'),
    mes: zod_1.z.number()
...
exports.updateCuotaSchema = zod_1.z.object({
    categoriaId: zod_1.z.string().cuid('ID de categoría inválido').optional(),
    mes: zod_1.z.number()
        .int('El mes debe ser un número entero')
        .min(1, 'El mes debe ser entre 1 y 12')
        .max(12, 'El mes debe ser entre 1 y 12')
...
exports.generarCuotasSchema = zod_1.z.object({
    ...
    anio: zod_1.z.number()
        ...
        .min(2020, 'El año debe ser 2020 o posterior')
        .max(2030, 'El año no puede ser mayor a 2030'),
    categoriaIds: zod_1.z.array(zod_1.z.string().cuid('ID de categoría inválido'))
...
exports.calcularCuotaSchema = zod_1.z.object({
    ...
    socioId: zod_1.z.string().cuid('ID de socio inválido').optional(),
...
exports.reporteCuotasSchema = zod_1.z.object({
    ...
    incluirDetalle: zod_1.z.boolean().default(true),
    incluirEstadisticas: zod_1.z.boolean().default(true)
});
