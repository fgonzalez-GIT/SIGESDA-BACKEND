...
const persona_dto_new_1 = require("@/dto/persona.dto.new");
...
class PersonaController {
    ...
    async createPersona(req, res, next) {
        try {
            const validatedData = persona_dto_new_1.createPersonaSchema.parse(req.body);
    ...
    async getPersonas(req, res, next) {
        try {
            const query = persona_dto_new_1.personaQuerySchema.parse(req.query);
    ...
    async updatePersona(req, res, next) {
        try {
            const { id } = req.params;
            const validatedData = persona_dto_new_1.updatePersonaSchema.parse(req.body);
    ...
    async reactivatePersona(req, res, next) {
        try {
            ...
            const validatedData = req.body && Object.keys(req.body).length > 0
                ? persona_dto_new_1.updatePersonaSchema.parse(req.body)
                : undefined;
...
//# sourceMappingURL=persona.controller.new.js.map