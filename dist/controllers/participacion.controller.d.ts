...
export declare class ParticipacionController {
    ...
    getParticipacionById(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    getParticipacionesByPersona(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    getParticipacionesByActividad(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    updateParticipacion(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    deleteParticipacion(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    inscripcionMasiva(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    inscripcionMultiplePersonas(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    desinscribir(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
    reactivarParticipacion(req: Request, res: Response): Promise<Response<any, Record<string, any>> | undefined>;
