            ...
            if (tipoCodigo === 'SOCIO') {
                ...
                if (!tipo.categoriaId) {
                    ...
                    if (categoriaActivo) {
                        ...
                        logger_1.logger.info(`Auto-asignada categoría ACTIVO (ID: ${categoriaActivo.id}) para nuevo socio`);
                    }
                    else {
            ...
            if (tipoCodigo === 'DOCENTE') {
                if (!tipo.especialidadId) {
                    ...
                    if (especialidad) {
                        ...
                        logger_1.logger.info(`Auto-asignada especialidad ${especialidad.nombre} (ID: ${especialidad.id}) para nuevo docente`);
                    }
                    else {
