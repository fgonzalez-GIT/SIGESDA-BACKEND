...
router.get('/socio/:socioId/familiares', familiarController.getFamiliarsBySocio.bind(familiarController));
router.get('/socio/:socioId/arbol', familiarController.getFamilyTree.bind(familiarController));
...
router.get('/verificar/:socioId/:familiarId', familiarController.checkRelationExists.bind(familiarController));
