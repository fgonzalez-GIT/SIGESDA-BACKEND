...
const ajuste_cuota_routes_1 = __importDefault(require("./ajuste-cuota.routes"));
const historial_cuota_routes_1 = __importDefault(require("./historial-cuota.routes"));
const exencion_cuota_routes_1 = __importDefault(require("./exencion-cuota.routes"));
const reportes_cuota_routes_1 = __importDefault(require("./reportes-cuota.routes"));
const simulador_cuota_routes_1 = __importDefault(require("./simulador-cuota.routes"));
const ajuste_masivo_routes_1 = __importDefault(require("./ajuste-masivo.routes"));
const rollback_cuota_routes_1 = __importDefault(require("./rollback-cuota.routes"));
const preview_cuota_routes_1 = __importDefault(require("./preview-cuota.routes"));
const cuota_batch_routes_1 = __importDefault(require("./cuota-batch.routes"));
...
router.use('/cuotas/reportes', reportes_cuota_routes_1.default);
router.use('/cuotas', cuota_routes_1.default);
router.use('/items-cuota', item_cuota_routes_1.default);
router.use('/ajustes-cuota', ajuste_cuota_routes_1.default);
router.use('/ajustes', ajuste_masivo_routes_1.default);
router.use('/exenciones-cuota', exencion_cuota_routes_1.default);
router.use('/historial-cuota', historial_cuota_routes_1.default);
router.use('/reportes/cuotas', reportes_cuota_routes_1.default);
router.use('/simulador/cuotas', simulador_cuota_routes_1.default);
router.use('/rollback/cuotas', rollback_cuota_routes_1.default);
router.use('/preview/cuotas', preview_cuota_routes_1.default);
router.use('/cuotas/batch', cuota_batch_routes_1.default);
