...
export class ReciboRepository {
  ...
  async create(data: CreateReciboDto): Promise<Recibo> {
    // ✅ ARCHITECTURE V2: numero is now auto-generated by PostgreSQL sequence
    // No need to pass numero, it's generated by next_recibo_numero() function
  ...
  async createBulk(recibos: CreateReciboDto[]): Promise<{ count: number }> {
    // ✅ ARCHITECTURE V2: numero is now auto-generated by PostgreSQL sequence
    // Each record will get a unique sequential number from next_recibo_numero()
    ...
    return this.prisma.recibo.createMany({
      data,
      skipDuplicates: false // Sequential numbers guarantee no duplicates
    });
  }
