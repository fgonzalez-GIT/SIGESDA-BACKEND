...
export const createCategoriaEquipamientoSchema = z.object({
  codigo: z.string()
...
export const updateCategoriaEquipamientoSchema = createCategoriaEquipamientoSchema.partial();
...
export const reorderCategoriaEquipamientoSchema = z.object({
